...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm text-[var(--text-dim)] opacity-70 transition-opacity hover:opacity-100 hover:text-[var(--brass)] focus:outline-none">
        <X className="h-4 w-4" />
